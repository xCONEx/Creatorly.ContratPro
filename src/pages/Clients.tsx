...
const Clients = () => {
  ...
  const fetchClients = async (showRefreshToast = false) => {
    ...
    try {
      ...
      // Separar por origem
      const contratpro = (data || []).filter(c => !c.origin || c.origin === 'contratpro');
      const financeflow = (data || []).filter(c => c.origin === 'financeflow');
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex space-x-1">
                        ...
                        <Button
                          variant={selectedClient === client ? "destructive" : "ghost"}
                          size="sm"
                          onClick={(e) => {
                            e.stopPropagation();
